  ...
  return (
    <Section>
      ...
      <div className="space-y-5">
        ...
        <Container className="flex flex-col items-start gap-6 rounded-lg border bg-accent/50 p-6 text-left md:rounded-xl md:p-12">
          <h1 className="!my-0 text-2xl sm:text-3xl font-bold">
            Tala.Lasalyano
          </h1>
          <h3 className="!mb-0 text-muted-foreground text-base sm:text-lg">
            <Balancer>
              My second genuine project after ACES. Anonymous letter posting.
              Nextjs + Supabase.
            </Balancer>
          </h3>
          <div className="not-prose flex items-center gap-2">
            {/* <Link
              href="https://github.com/eligibilityy/tala-lasalyano"
              className="flex items-center space-x-1"
              target="_blank"
            > */}
            <Button
